...
define( 'TWELLER_FLOW_2_VERSION', '3.50.0' );
...
require_once TWELLER_FLOW_2_PLUGIN_DIR . 'includes/class-image-consent.php';
...
function tweller_flow_2_activate() {
    ...
    TwellerFlow2_Gallery_Favorites::create_tables();
    ...
    TwellerFlow2_Image_Consent::ensure_page();
    flush_rewrite_rules();
}
...
function tweller_flow_2_init() {
    ...
    TwellerFlow2_Image_Consent::init();
    ...
    // Auto-build the "Why this fee?" privacy-fee page once (cheap option read
    // on repeat requests), same self-heal pattern as the other plugin pages.
    TwellerFlow2_Image_Consent::ensure_page();
